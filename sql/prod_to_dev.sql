...
-- Cooking Assistant
UPDATE cooking.recipes SET name = CONCAT('Recipe ', CAST(id AS text)) WHERE user_id > 3;
UPDATE cooking.ingredients SET name = CONCAT('Ingredient ', CAST(id AS text)) WHERE user_id > 3;
