export default class Variables {
	static urls = {
		...
		api: import.meta.env.VITE_GATEWAY_URL + '/trainer/api',
		defaultProfileImageUrl: 'https://res.cloudinary.com/personalassistant/w_40,h_40,c_limit/production/defaults/sfmqac.webp'
	};
