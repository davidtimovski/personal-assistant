export default {
	'en-US': {
		...
		stocks: 'Stocks',
		stocksBetween: 'Stocks must be between {{from}} and {{to}}',
		...
		editTransaction: {
			...
			anAccountIsRequired: 'At least one account needs to be selected',
			accountsCannotBeEqual: 'From and To accounts cannot be the same',
		...
		editAccount: {
			...
			edit: 'Edit',
			mainAccount:
				'This is your main account. It represents your current capital and by default every new expense or deposit goes here. You cannot delete this account.',
	...
	'mk-MK': {
		...
		stocks: 'Акции',
		stocksBetween: 'Акциите мора да бидат помеѓу {{from}} и {{to}}',
		...
		editTransaction: {
			...
			anAccountIsRequired: 'Потребно е да биде селектирана барем една сметка',
			accountsCannotBeEqual: 'Од и До сметките неможат да бидат исти',
		...
		editAccount: {
			...
			edit: 'Промени ја',
			mainAccount:
				'Ова е вашата главна сметка. Го репрезентира вашиот моментален капитал и обично секој нов трошок или депозит доаѓа тука. Неможете да ја избришете оваа сметка.',
