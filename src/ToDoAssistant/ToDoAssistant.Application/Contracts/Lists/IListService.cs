...
{
    Result<IEnumerable<ListDto>> GetAll(int userId, ISpan metricsSpan);
    Result<IEnumerable<ToDoListOption>> GetAllAsOptions(int userId, ISpan metricsSpan);
    Result<IEnumerable<Assignee>?> GetMembersAsAssigneeOptions(int id, int userId, ISpan metricsSpan);
    ...
    Result<IEnumerable<ShareListRequest>> GetShareRequests(int userId, ISpan metricsSpan);
    ...
    Result<IEnumerable<User>> GetUsersToBeNotifiedOfChange(int id, int excludeUserId, bool isPrivate, ISpan metricsSpan);
    Result<IEnumerable<User>> GetUsersToBeNotifiedOfChange(int id, int excludeUserId, int taskId, ISpan metricsSpan);
